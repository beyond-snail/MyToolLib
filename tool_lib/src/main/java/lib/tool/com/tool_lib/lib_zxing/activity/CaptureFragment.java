package lib.tool.com.tool_lib.lib_zxing.activity;
...
import lib.tool.com.tool_lib.lib_zxing.decoding.CaptureActivityHandler;
import lib.tool.com.tool_lib.lib_zxing.decoding.InactivityTimer;
import lib.tool.com.tool_lib.lib_zxing.view.ViewfinderView;
...
//        }
            ...
            if ("1".equals(titleType) ){
                ...
                view.findViewById(R.id.backBtn).setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (onListener != null) {
                            onListener.doSomeThing("", 1);
                        }
                    }
                });
                view.findViewById(R.id.id_edit).setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (onListener != null) {
                            onListener.doSomeThing("", 2);
                        }
                    }
                });
            }else{
    ...
    public void setOnListener(CaptureFragment.onListener onListener) {
        this.onListener = onListener;
    }

    public interface onListener {
        void doSomeThing(String messgae, int type);
    }
