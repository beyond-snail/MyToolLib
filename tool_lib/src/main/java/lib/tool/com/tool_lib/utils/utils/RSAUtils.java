...
//	 * @Exception 异常对象
//	*/
//	public static String fy_sign(String srcSignPacket)
...
//     *  
//     */  
//    public static boolean fy_verify(byte[] data, String sign,String ins_cd)  
//            throws Exception {  
//  
//    	publicKey = Configure.getConfig(ins_cd+"publicKey");
//        // 解密由base64编码的公钥  
