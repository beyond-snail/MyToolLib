...
public class ZzHorizontalProgressBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        useRectMode = a.getBoolean(R.styleable.ZzHorizontalProgressBar_zpb_use_rect_mode, true);
    ...
    public boolean isUseRectMode() {
        return useRectMode;
    }

    public void setUseRectMode(boolean useRectMode) {
        this.useRectMode = useRectMode;
    }
